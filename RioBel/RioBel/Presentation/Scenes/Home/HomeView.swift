    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 0) {
                ...
                // Barra ou Botão de Tokens
                tokenBarView
                    .padding(.horizontal, 16)
                    .padding(.bottom, 18)

                // Container branco com bordas superiores arredondadas e grid de opções
                menuSheet
            }
    ...
    private var balanceSection: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("Saldo disponível")
                ...
                .foregroundColor(RioBelColors.textSecondary)
                .padding(.top, 2)
    ...
    private var tokenBarView: some View {
        if viewModel.canGenerateToken {
            Button(action: viewModel.openGenerateToken) {
                ...
                .foregroundColor(RioBelColors.primaryBlue)
            ...
            Text("Ainda não há saldo para gerar tokens")
                ...
                .frame(maxWidth: .infinity)
                .frame(height: 44)
                .background(RioBelColors.tokenBarBackground)
                .cornerRadius(8)
        }
    }
